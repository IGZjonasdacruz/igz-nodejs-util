...
var MongoClient = require('mongodb').MongoClient,
	...
	debug = require('debug')('igz-util.mongodb');
...
function getMongoDB (callback) {
	...
	//
	// The connection string looks like 'mongodb://127.0.0.1:27017/databasename?w=1'
	...
	// 
	MongoClient.connect(config.db.conn, function(err, database) {
